...
app.whenReady().then(() => {
  createWindow();
  // Verrouiller tous les raccourcis de sortie
  globalShortcut.register('Escape', () => null);
  globalShortcut.register('Alt+F4', () => null);
  globalShortcut.register('Alt+Tab', () => null);
  globalShortcut.register('Win', () => null);
  globalShortcut.register('Super', () => null);
  globalShortcut.register('Win+Tab', () => null);
  globalShortcut.register('Super+Tab', () => null);
  globalShortcut.register('CommandOrControl+Q', () => null);
});
